  ...
  NETHUM.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      await NETHUM.sendMessage(ownerNumber[0] + "@s.whatsapp.net", {
        image: { url: `https://github.com/NETHUM-MD/NETHUM-MD/blob/main/images/NETHUM-MD.png?raw=true` },
        caption: up
      });
...
app.get("/", (req, res) => {
  res.send("Hey, NETHUM-MD WP BOT STARTED✅");
});
